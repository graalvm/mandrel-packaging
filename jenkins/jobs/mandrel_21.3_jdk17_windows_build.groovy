...
job('mandrel-21.3-jdk17-windows-build') {
    label 'w2k19'
    displayName('Windows Build :: 21.3 :: JDK 17')
    description('''
Windows build for 21.3 branch with JDK17.
    ''')
    logRotator {
        numToKeep(5)
    }
    ...
    publishers {
        ...
        downstreamParameterized {
            trigger(['mandrel-windows-quarkus-tests', 'mandrel-windows-integration-tests']) {
                ...
                parameters {
                    currentBuild()
                    matrixSubset('(MANDREL_VERSION=="21.3-jdk17" && LABEL=="w2k19")')
                }
            }
        }
    }
